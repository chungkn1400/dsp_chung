...
#Define zstringptr String'ZString ptr
...
#If Not Defined(guinogfx)
  ScreenRes guiscreenx,guiscreeny,guidepth,1,fb.gfx_null'-1
#EndIf 
...
End Sub
/'
Dim Shared As uint guigfxcolor=RGBA(255,255,255,255)
Dim Shared As uint guigfxbackcolor=RGBA(0,0,0,255)
Sub guidrawcolor (ByVal r As uint,ByVal g As uint,_  
	                         ByVal b As uint,ByVal a As uint)
guigfxcolor=RGBA(r,g,b,a)
Color guigfxcolor,guigfxbackcolor
End Sub
Sub guidrawbackcolor (ByVal r As uint,ByVal g As uint,_  
	                         ByVal b As uint,ByVal a As uint) 
guigfxbackcolor=RGBA(r,g,b,a)
Color guigfxcolor,guigfxbackcolor
End Sub
Sub guidrawstringbuffer (ByVal buffer As Any Ptr,_ 
	            ByVal x As integer,ByVal y As Integer,ByVal text As zstringptr)
Draw String buffer,(x,y),text,guigfxcolor
End Sub 
Sub guidrawstring (ByVal wingraph As zstringptr,_ 
	            ByVal x As integer,ByVal y As Integer,ByVal text As zstringptr)
Draw String getguigfxbuffer(wingraph),(x,y),text,guigfxcolor
End Sub 
Sub guidrawcmdbuffer (ByVal buffer As Any Ptr,_ 
	            ByVal cmd As zstringptr)
Draw buffer,cmd
End Sub 
Sub guidrawcmd (ByVal wingraph As zstringptr,_ 
	            ByVal cmd As zstringptr)
guidrawcmdbuffer(getguigfxbuffer(wingraph),cmd)
End Sub 
Sub guidrawlinebuffer (ByVal buffer As Any Ptr,_ 
	            ByVal x1 As integer,ByVal y1 As Integer, _  
	            ByVal x2 As integer,ByVal y2 As Integer)
Line buffer,(x1,y1)-(x2,y2),guigfxcolor
End Sub 
Sub guidrawline (ByVal wingraph As zstringptr,_ 
	            ByVal x1 As integer,ByVal y1 As Integer, _  
	            ByVal x2 As integer,ByVal y2 As Integer)
Line getguigfxbuffer(wingraph),(x1,y1)-(x2,y2),guigfxcolor
End Sub 
Sub guidrawboxbuffer (ByVal buffer As Any Ptr,_ 
	            ByVal x1 As integer,ByVal y1 As Integer, _  
	            ByVal x2 As integer,ByVal y2 As Integer,ByVal fill As uint=0)
If fill=0 Then
	Line buffer,(x1,y1)-(x2,y2),guigfxcolor,B
Else 
	Line buffer,(x1,y1)-(x2,y2),guigfxcolor,BF
EndIf
End Sub 
Sub guidrawbox (ByVal wingraph As zstringptr,_ 
	            ByVal x1 As integer,ByVal y1 As Integer, _  
	            ByVal x2 As integer,ByVal y2 As Integer,ByVal fill As uint=0) 
If fill=0 Then 
	Line getguigfxbuffer(wingraph),(x1,y1)-(x2,y2),guigfxcolor,B
Else 
	Line getguigfxbuffer(wingraph),(x1,y1)-(x2,y2),guigfxcolor,BF
EndIf
End Sub 
Sub guidrawcirclebuffer (ByVal buffer As Any Ptr,_ 
	            ByVal x As integer,ByVal y As Integer, _  
	            ByVal r As uint,ByVal fill As uint=0) 
If fill=0 Then
	Circle buffer,(x,y),r,guigfxcolor
Else 
	Circle buffer,(x,y),r,guigfxcolor,,,,F
EndIf
End Sub 
Sub guidrawcircle (ByVal wingraph As zstringptr,_ 
	            ByVal x As integer,ByVal y As Integer, _  
	            ByVal r As uint,ByVal fill As uint=0)
If fill=0 Then
	Circle getguigfxbuffer(wingraph),(x,y),r,guigfxcolor
Else 
	Circle getguigfxbuffer(wingraph),(x,y),r,guigfxcolor,,,,F
EndIf
End Sub 
Sub guidrawpointbuffer (ByVal buffer As Any Ptr,_ 
	            ByVal x As integer,ByVal y As Integer)
PSet buffer,(x,y),guigfxcolor
End Sub  
Sub guidrawpoint (ByVal wingraph As zstringptr,_ 
	            ByVal x As integer,ByVal y As Integer)
PSet getguigfxbuffer(wingraph),(x,y),guigfxcolor
End Sub 
Sub guidrawfillbuffer (ByVal buffer As Any Ptr,_ 
	            ByVal x As integer,ByVal y As Integer) 
Paint buffer,(x,y),guigfxcolor
End Sub  
Sub guidrawfill (ByVal wingraph As zstringptr,_ 
	            ByVal x As integer,ByVal y As Integer)
Paint getguigfxbuffer(wingraph),(x,y),guigfxcolor
End Sub 
'/